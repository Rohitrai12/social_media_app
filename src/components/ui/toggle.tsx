...
>(
  ({ className, variant, size, onContent, offContent, ...props }, ref) => {
    // Use state to manage toggle state
    ...
    // Determine the content to display based on the toggle state
    const content = isOn ? onContent : offContent;
